window.settings.i18n['en-US'] = {
  ...
  '购买套餐': 'Purchase Subscription',
  '工单客服': 'My Tickets',
  '导航': 'NAVIGATION',
  '下载客户端以及学习如何使用': 'Learn how to use',
  '充值': 'Recharge',
  '礼品卡': 'Gift Card',
  '请输入礼品卡': 'Please enter gift card',
  '兑换': 'exchange',
  '访问导航': 'Access navigation',
  '搜索使用教程': 'Search Tutorial',
  '财务': 'Billing',
  '我的订单': 'My Orders',
  '我的邀请': 'My Invitation',
  '用户': 'Account',
  ...
  '使用教程&下载客户端': 'I am a newbie, view the tutorial',
  '查看使用教程&下载客户端': 'View Knowledge',
